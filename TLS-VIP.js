...
console.log('[INFO]: Missing proxy.txt');
process.exit();
}
...
var parsed = url.parse(objetive);
    ...
    console.log('[USAGE]: node TLS-VIP.js <URL> <TIME> Made By Your Qt gorr#2600');
    process.exit();
}
const sigalgs = [
...
var UAs = fs.readFileSync('ua.txt', 'utf-8').replace(/\r/g, '').split('\n');
     ...
     console.log('[INFO]: Missing ua.txt')
 }
class TlsBuilder {
    constructor (socket){
